...
-- NOTE: environment variables can only be changed by quitting the window manager, changing them at runtime is unsafe
...
local tags = { "1󰈹 ", "2 ", "3 ", "4 ", "5󰻞 ", "6 ", "7? ", "8󰓓 ", "9 " }
-- local tags = { "󰈹 ¹", " ²", " ³", " ⁴", "󰻞 ⁵", " ⁶", "? ⁷", "󰓓 ⁸", " ⁹" }
...
local function block_separator()
...
local blocks = {
	...
	oxwm.bar.block.shell({
		...
		color = colors.volume,
		underline = true,
		click = "wpctl set-mute @DEFAULT_SINK@ toggle",
	}),
	block_separator(),
...
oxwm.border.set_focused_color(colors.focus)
...
-- https://github.com/tonybanters/oxwm/blob/afc403f33e4882f3007fb2d5aead402c1dba7ebd/src/config/lua.zig#L1420
...
oxwm.key.bind({}, "XF86AudioPause", oxwm.spawn({ "playerctl play-pause" }))
